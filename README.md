...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 54f85cc1-1171-4177-9c5c-ec696a32f655
```

> `54f85cc1-1171-4177-9c5c-ec696a32f655` is the password of the certificate, you can change it to any password you want.
